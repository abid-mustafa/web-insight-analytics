...
def processingInput(inputPrompt, website_id):
    ...
    f"- Use DATE() when comparing or grouping by timestamp fields (e.g., created_at). \n"
    ...
    f"*Rejected out of scope query*\n"
    f"   Input: 'How are you?'\n"
    f"   Output: {{'prompt_type': 'out_of_domain', 'answer': 'This query is out of scope for the analytics domain.'}}\n\n"
