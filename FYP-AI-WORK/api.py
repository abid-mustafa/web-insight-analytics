...
import IntelligentSearchBar as IS
from Models.Kaplien_Meier.KMExcecution import ExcecuteKM
from Models.Prophet.ProphetExecution import ExecuteProphet
from Models.KMeans.KMeansExecution import ExcecuteKMeans
from Models.TPS.TPSExcecution import ExecuteTPS
...
def AIDrivenReport():
    ...
    if Kaplen_Report and Prophet_Report and KMeans_Report and TPS_Report:
        ...
        if pdf_response.status_code == 200:
            ...
            return jsonify({"error": "PDF generation failed", "details": pdf_response.text}), 500

    else:
        return jsonify({'message':'unsuccessfull',"Error": "Data not found"}),404
